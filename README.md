...
1. Start AEM Proxy: `npm start`. This runs `aem up` (opens your browser at `http://localhost:3000`) and
a file watcher to recompile the scss files to css files in parallel with concurrently
